...
class TrackingProjectionRebuildTest {
    ...
    void rebuildingReproducesTheLiveProjectionEvenWithJitter() {
        ...
        load(deliveryId, providerId, driverId, LoadMilestone.LOADED, 100.0, "2026-10-01T09:00:00Z");
        ...
        load(deliveryId, providerId, driverId, LoadMilestone.UNLOADED, null, "2026-10-01T11:00:00Z");
    ...
    void rebuildingReproducesTheProjectionForOutOfOrderLoadMilestones() {
        ...
        load(jitteredDeliveryId, providerId, driverId, LoadMilestone.LOADED, 80.0, "2026-10-01T08:00:00Z");
        load(jitteredDeliveryId, providerId, driverId, LoadMilestone.UNLOADED, null, "2026-10-01T11:00:00Z");
        load(jitteredDeliveryId, providerId, driverId, LoadMilestone.LOADED, 80.0, "2026-10-01T09:00:00Z");
        ...
        assertThat(live.lastLoadAt()).isEqualTo(Instant.parse("2026-10-01T11:00:00Z"));
        ...
        load(orderedDeliveryId, providerId, driverId, LoadMilestone.LOADED, 80.0, "2026-10-01T08:00:00Z");
        load(orderedDeliveryId, providerId, driverId, LoadMilestone.LOADED, 80.0, "2026-10-01T09:00:00Z");
        load(orderedDeliveryId, providerId, driverId, LoadMilestone.UNLOADED, null, "2026-10-01T11:00:00Z");
    ...
    void rebuildingSurvivesRawEvidenceWithAChronologicallyImpossibleLoadSequence() {
        ...
        load(deliveryId, providerId, driverId, LoadMilestone.LOADED, 50.0, "2026-10-01T08:00:00Z");
        load(deliveryId, providerId, driverId, LoadMilestone.UNLOADED, null, "2026-10-01T07:00:00Z");
