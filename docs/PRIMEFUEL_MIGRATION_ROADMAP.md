...
| T16-A | S16 | Contrato de evidencia de transporte (driver-app, rediseño W6) | Vincular muestras a delivery vía app del conductor. | `tracking` module/API, delivery tracking | T12-B, T13-B, T14-B + U10/U18 (registradas en T16-B) | Definir payload posición/hito; validar driver asignado (`FleetReservation.driverId`); crear storage/projection. |
